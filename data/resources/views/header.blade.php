...
<link rel="stylesheet" href="{{ asset('assets/css/separate/vendor/datatables-net.min.css')}}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/separate/pages/activity.min.css')}}">
...
<!-- <link rel="stylesheet" href="{{ asset('assets/css/lib/bootstrap-table/bootstrap-table.min.css')}}">
	<link rel="stylesheet" href="{{ asset('assets/css/lib/bootstrap-table/bootstrap-table-fixed-columns.css')}}"> -->
 <!-- moris js -->
 <style type="text/css">
 	.box_tabel{
 		width: 100%;
